test_that("use", {
  ...
  expect_false(is_on_bianca_login_node(host_name = "r1234"))
  expect_false(is_on_bianca_login_node(host_name = "nonsense"))
  expect_error(is_on_bianca_login_node(host_name = NA))
  expect_error(is_on_bianca_login_node(host_name = NULL))
  expect_error(is_on_bianca_login_node(host_name = Inf))
